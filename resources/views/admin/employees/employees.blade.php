                        ...
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                            <div class="profile-widget">
                                <div class="profile-img">
                                    <a href="{{route('admin.employees.profile',$item->id)}}" class="user-pf-tp">
                                        <span class="avatar">
                                            <img src="@if($item->image != NULL){{ asset('storage/uploads/' . $item->image) }}@else{{ asset('assets/img/avtar.jpg')}}@endif"></span>
                                            @if ($item->status == 0)
                                            <span
