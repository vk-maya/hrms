    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.storeemployees') }}" enctype="multipart/form-data" method="POST" id="regForm">
                                @csrf
                                ...
                                <div class="row   justify-content-center">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 form-group">
                                            <div class="">
                                                ...
                                                <div class="">
                                                    <input type="date" class="form-control" required name="dob" mini
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required type="text" class="form-control" name="machineID" id="machine"
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 form-group">
                                            <label class="col-form-label">Department <span
                                                class="text-danger">*</span></label>
                                                <select class="select" required name="department_id" class="form-control"
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 form-group">
                                            <label class="col-form-label">Designation <span
                                                class="text-danger">*</span></label>
                                                <select class="select" name="designation_id" id="inputDesignation" required>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 form-group">
                                            <label for="statusinput" class="mb-3 mt-2">Status</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @foreach ($salared as $item)
                                                        @if ($item->salarymanag->type == 'earning')
                                                            <div>
                                                                <label class="checkbox-inline me-3"><input @if(isset($salaryedit) && in_array($item->id,$salaryedit->toArray())) checked @endif type="checkbox" value="{{$item->id}}" name="earning[]" class="days recurring"
                                                                    ></label><span
