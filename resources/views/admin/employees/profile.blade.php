                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt="" src="@if($employees->image != NULL){{ asset('storage/uploads/' . $employees->image) }}@else{{ asset('assets/img/avtar.jpg')}}@endif"></a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <h6 class="text-muted">
                                                <b>{{ $employees->department->department_name }}</b> - {{ $employees->profiledesignation->designation_name }}
                                            </h6>
                                            ...
                                            <div class="staff-msg"><a class="btn add-btn" href="{{ route('admin.emp.show-taskk', $employees->id) }}">Show-Task</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        ...
                        <li class="nav-item"><a href="#bank_statutory" data-bs-toggle="tab" class="nav-link">Bank & Statutory <small class="text-danger">(Admin
                                    Only)</small></a>
                        </li>
                    </ul>
                </div>
