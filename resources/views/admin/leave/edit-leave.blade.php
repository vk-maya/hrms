                    ...
                    <div class="card-body">
                        <form action="{{route('admin.leave.update')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select" name="type">
                                    ...
                                    @foreach ($type as $item)
                                        <option value="{{$item->id }}" @if($data->leaves_id ==$item->id)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input class="form-control" name="from" type="date" value="{{$data->form}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input class="form-control " name="to" value="{{$data->to}}" type="date"
                                                 id="todate">
                                            @error('to')
                                                <span class="text-danger">
                                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="reason" rows="4" class="form-control">{{$data->reason}}</textarea>
                                @error('reason')
                                    <span class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </span>
