                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="#leave_request" data-bs-toggle="tab" class="nav-link active ">Leave
                                    ...
                                    @endif</small></a></li>
                            <li class="nav-item"><a href="#wfh_request" data-bs-toggle="tab" class="nav-link ">WFH
                                    Request <small class="text-danger">@if(isset($wfhcount) && $wfhcount != null)({{$wfhcount}})                                        
                                    @endif</small></a></li>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                @endphp
                                                <td><a
                                                        href="{{ route('admin.leave.view', $item->id) }}">{{ $item->user->first_name }}</a>
                                                </td>
