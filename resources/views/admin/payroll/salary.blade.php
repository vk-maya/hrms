        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#addsalary"><i class="fa fa-plus"></i>Add Salary eran And Deducation</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table cus-table-striped custom-table mb-4 employee-salary">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ route('admin.salary.earn.deducation', $item->id) }}"><i class="fa fa-pencil me-2"></i> Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <table class="table cus-table-striped custom-table mb-0 employee-salary">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
                ...
                <form action="{{ route('admin.salary.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>{{ $item->title }} %</label>
                                <input class="form-control" name="ids[{{$item->id}}]" {{-- <input class="form-control" name="ids[{{strtolower(str_replace(" ","_", $item->title))}}]" --}} type="text" value="">
                            </div>
                            @endif
                            @endforeach
                        </div>
