		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="submenu @if(in_array(\Request::route()->getName(), [" admin.departments", "admin.designation" ])) active @endif">
					<a href="#"><i class="fa fa-sitemap" aria-hidden="true"></i> <span>Departments</span> <span class="menu-arrow"></span></a>
				...
				<li class="submenu @if (in_array(\Request::route()->getName(), [" admin.payroll.list"])) active @endif">
					...
					<ul style="display: none;">
						<li><a class="@if (\Request::route()->getName() == 'admin.payroll.list') active @endif" href="{{route('admin.payroll.list')}}"> Employee Salary </a></li>
					</ul>
				</li>
				<li class="submenu @if(in_array(\Request::route()->getName(), [" admin.emp.report"])) active @endif">
					<a href="#"><i class="la la-pie-chart"></i> <span>Report</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
				...
				<li class="submenu @if(in_array(\Request::route()->getName(), [" admin.all.task.list"])) active @endif">
					<a href="#"><i class="la la-edit"></i> <span> Task</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
