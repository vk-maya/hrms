                    ...
                    <table class="table cus-table-striped custom-table mb-0 data-table-theme">
                        <thead>
                            <tr>
                                ...
                                @for ($i = 1; $i <= $month; $i++) @php $day=date('D', strtotime('2022-08-'.$i)); @endphp @if ($day=='Sun' ) <th colspan="3" style="text-align:center;color:green;">
                                    @else
                            ...
                            <tr>
                                @for ($i = 1; $i <= $month; $i++) <th>In Time</th>
                                    <th>Out Time</th>
                                    <th>Attend</th>
                                    @endfor
                                    <th>Present</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @for ($i = 1; $i <= $month; $i++) @php $sunday=date('w', strtotime("2022-08-".$i)); if($sunday==0){ $sunday_count++; } @endphp @if (in_array(date("Y-m-d",strtotime(now()->format("Y-08-").$i)),$item->attendence->pluck('date')->toArray()))
