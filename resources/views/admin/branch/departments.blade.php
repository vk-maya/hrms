            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end">
                        <a href="#" class="btn add-btn show" data-bs-toggle="modal"
                            data-bs-target="#myModal"><i class="fa fa-plus"></i> Add Department</a>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.departments') }}" method="POST" id="formId">
                        @csrf                     
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="Designationinput">Department</label>
                                <input type="text" autocomplete="off" name="department" class="form-control" placeholder="Enter Department"
