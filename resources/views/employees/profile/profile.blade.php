            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto float-end ms-auto">
                        <a href="{{ route('employees.employees.document', Auth::guard('web')->user()->id) }}"
                            class="btn add-btn"><i class="fa fa-file-o" aria-hidden="true"></i>
                            </i>View Document</a>
                        @if ($moreinfo < 0)
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            ...
                            <li class="nav-item"><a href="#emp_doucment" data-bs-toggle="tab"
                                    class="nav-link">View Document</a></li>
                        </ul>
                    </div>
                </div>
          
            <div class="tab-content">
                <div id="emp_doucment" class="pro-overview tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    @if(count($files)>0)                                                                    
                                    <h1 class="card-title">View Document</h1>
                                    <div class="row">   
                ...
                <div id="emp_profile" class="pro-overview tab-pane fade show active">
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h1 class="card-title"><b></b> Personal Informations</b> </h1>
                                    <ul class="personal-info">
                                        <li>
