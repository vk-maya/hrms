            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item"><a href="#leave" data-bs-toggle="tab" class="nav-link active">Leave</a></li>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class=""> <strong> PL </strong>
                                        <div class="">
                                            {{ $anual = $month->anualLeave - $month->apprAnual }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-striped custom-table mb-0 data-table-theme">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $item->day }}</td>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#reson{{ $item->id }}">{{ \Illuminate\Support\Str::limit($item->reason, 20, '..') }}</a>
                                        </td>
                                        <td class="text-center">
                                            <div class="">
                                                @if ($item->status == 2)
                                                <span class="item  btn-white btn-sm btn-rounded "><i class="fa fa-dot-circle-o text-purple"></i>
                                                    New</span>
                                                @elseif($item->status == 0)
                                                <span class="item  btn-white btn-sm btn-rounded"><i class="fa fa-dot-circle-o text-danger"></i>
                                                    Declined</span>
                                                @else
                                                <span class="item  btn-white btn-sm btn-rounded"><i class="fa fa-dot-circle-o text-success"></i>
                                                    Approved</span>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('employees.leave.delete', $item->id) }}"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                        @else
